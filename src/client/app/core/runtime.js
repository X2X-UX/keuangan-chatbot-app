...
const elements = {
  ...
  budgetAlertActionButton: document.getElementById("budgetAlertActionButton"),
  budgetAlertBadge: document.getElementById("budgetAlertBadge"),
  budgetAlertBanner: document.getElementById("budgetAlertBanner"),
  budgetAlertText: document.getElementById("budgetAlertText"),
  budgetAlertTitle: document.getElementById("budgetAlertTitle"),
  ...
  financeDetailLead: document.getElementById("financeDetailLead"),
  financeDetailList: document.getElementById("financeDetailList"),
