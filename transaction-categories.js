(() => {
  const sharedTransactionCategoryOptions = {
    expense: [
      "Makanan",
      "Transportasi",
      "Tagihan",
  ...
  function getTransactionCategories(type) {
    return Array.isArray(sharedTransactionCategoryOptions[type]) ? [...sharedTransactionCategoryOptions[type]] : [];
  }
  ...
  const transactionCategoryExports = {
    TRANSACTION_CATEGORY_OPTIONS: sharedTransactionCategoryOptions,
  ...
  if (typeof module !== "undefined" && module.exports) {
    module.exports = transactionCategoryExports;
  }
